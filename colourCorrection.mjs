...
const getColorFilterMatrix = (pixels, width, height) => {
...
const calculateAverageColor = (pixels, width, height) => {
...
const normalizingInterval = (normArray) => {
    let high = 255;
    let low = 0;
    let maxDist = 0;
